...
def recommend():
    ...
    if type(r) == type('string'):  # no such movie found in the database
        ...
        # getting list of genres from json
        genre = ListOfGenres(data_json['genres'])

        # Web scraping to get user reviews from IMDb site
        # Create a request object with User-Agent
        headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.83 Safari/537.36'}
        request_url = 'https://www.imdb.com/title/{}/reviews?ref_=tt_ov_rt'.format(imdb_id)
        ...
        try:
            ...
            return render_template('recommend.html', movie=movie, r="Failed to retrieve reviews.", t='s')
        except Exception as e:
            print(f"An error occurred: {e}")
            return render_template('recommend.html', movie=movie, r="An error occurred.", t='s')
